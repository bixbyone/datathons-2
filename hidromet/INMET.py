...
class INMET:
    ...
    def obter_dados_estacao(self, data_inicial: str, data_final: str, cod_estacao: str, freq: Literal['H', 'D'] = 'H') -> List[Dict[str, str]]:
        """
        ...
        url_requisicao = f"{self.url_base}/estacao/{freq_}{data_inicial}/{data_final}/{cod_estacao}"
